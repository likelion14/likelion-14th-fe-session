...
function MovieFavorites() {
    ...
    //         .then(data => { // Ensure data is an array before setting it to state
    //             if (Array.isArray(data)) {
    //                 setFavorites(data);
    //             } else {
    //                 // Handle unexpected data format, default to an empty array
    //                 setFavorites([]);
    //                 setError('찜한 영화 목록 데이터 형식이 올바르지 않습니다.');
