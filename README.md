...
| 4주차 | 2026. 4. 2. | React 기초 | 하루 루틴 카드 만들기 |
| 5주차 | 2026. 4. 9. | Element, Component 와 Lifecycle | 기분 프로필 만들기 |
| 8주차 | 2026. 4. 30. | Hook, Form, Context, Router | 감정 일기장 만들기 |
| 9주차 | 2026. 5. 7. | 리디렉션, 네비게이션, 중첩 라우트와 로그인 보호 | 넷플릭스 로그인 화면 클론코딩 |
